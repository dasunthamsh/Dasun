...
bg-gradient-to-b from-[#DF8645] via-[#9D5E2D] via-[#563117] to-[#000000]">
      ...
      <div className="relative h-full mx-auto text-center px-6 pt-24 w-[100%] sm:w-[60%] max-w-[1100px] z-20">
        ...
        <div
          className={`fixed bottom-[15%] z-20 w-full max-w-[600px] transition-all duration-500 ${
            showDasunText ? 'opacity-100 visible' : 'opacity-0 invisible'
          } left-0 sm:left-1/2 sm:-translate-x-1/2`}
        >
          <p className="font-nimbus text-sm sm:text-xl leading-relaxed font-medium mx-3 sm:mx-0 mb-0 lg:mb-32">
